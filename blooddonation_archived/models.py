...
class BloodRequest(models.Model):
    ...
    blood_group = models.CharField(max_length=3, choices=DonorProfile.BLOOD_GROUP_CHOICES, db_index=True)
...
class DonationHistory(models.Model):
    ...
    request = models.ForeignKey(BloodRequest, on_delete=models.SET_NULL, null=True, blank=True, related_name="donation_histories")
